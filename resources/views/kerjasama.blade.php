    ...
    <div class="partnership-carousel">
        <div class="partnership-container">
            <div class="partnership-item">
                <img src="gambar/lsp.png" alt="Bonet Logo" class="partner-logo">
                <h2>PT Bonet Utama</h2>
            </div>
            <div class="partnership-item">
                <img src="gambar/lsp.png" alt="Teknologi Maju Logo" class="partner-logo">
                <h2>PT Teknologi Maju</h2>
            </div>
            <div class="partnership-item">
                <img src="gambar/lsp.png" alt="ADI Logo" class="partner-logo">
                <h2>Asosiasi Digital Indonesia</h2>
            </div>
            <div class="partnership-item">
                <img src="gambar/lsp.png" alt="GTS Logo" class="partner-logo">
                <h2>Global Tech Solutions</h2>
            </div>
            <div class="partnership-item">
                <img src="gambar/lsp.png" alt="CSA Logo" class="partner-logo">
